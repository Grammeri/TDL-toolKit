...
test('status of specified task should be changed', () => {
    const action = tasksActions.updateTask({todolistId:"2", model:{status: TaskStatuses.New}, taskId:"todolistId2"});
...
test('title of specified task should be changed', () => {
    const action = tasksActions.updateTask({todolistId:"2", model:{title: "yogurt"}, taskId:"todolistId2"});
